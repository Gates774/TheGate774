// Nigerian States, LGAs and FCT Area Councils
// Source of truth for location selection across THE GATE® app.
// 36 states + FCT. LGA names normalized as provided by the user.
...
export const NIGERIA_LGAS: Record<string, string[]> = {
  ...
  "Ekiti": [
    "Ado-Ekiti","Efon","Ekameji","Ekiti East","Ekiti South-West","Ekiti West",
  ...
  "Kano": [
    ...
    "Kiru","Kumbotso","Kunchi","Kura","Madobi","Makoda","Minjibir","Nasarawa","Rano",
  ...
  "Katsina": [
    ...
    "Dan Musa","Daura","Dutsi","Faskari","Funtua","Ingawa","Jibia","Kafur","Kaita",
    "Kankara","Kankia","Katsina","Kurfi","Kusada","Mai'Adua","Malumfashi","Mani",
    "Mashi","Matazu","Musawa","Rimi","Sabuwa","Safana","Sandamu","Zango",
  ],
  "Kebbi": [
    "Aleiro","Arewa Dandi","Argungu","Augie","Bagudo","Birnin Kebbi","Bunza",
    "Dandi","Danko/Wasagu","Fakai","Gwandu","Jega","Kalgo","Koko/Besse","Maiyama",
  ...
  "Oyo": [
    ...
    "Ibarapa East","Ibarapa North","Ido","Irepo","Itesiwaju","Iwajowa","Kajola",
    "Lagelu","Ogbomosho North","Ogbomosho South","Ogo Oluwa","Olorunsogo","Oluyole",
    "Ona Ara","Orelope","Ori Ire","Oyo East","Oyo West","Saki East","Saki West",
    "Surulere",
  ],
  "Plateau": [
...
export const NIGERIA_STATES_WITH_LGAS = Object.keys(NIGERIA_LGAS).sort();

export function getLgasForState(state: string): string[] {
  return NIGERIA_LGAS[state] ?? [];
}

export function isFCT(state: string): boolean {
  return state === "FCT - Abuja";
}